...
CFLAGS_CLI=-O3 -DNDEBUG -Os -Ofast -Og -s -march=native -flto=auto -funroll-all-loops -std=c++23
TARGET_CLI=./src/ui/cli/cli.cc
OUT_CLI=./todo

CFLAGS_GUI=-O3 -Os -Ofast -Og -s -march=native -flto=auto -funroll-all-loops -std=c++23 `pkg-config --cflags --libs gtkmm-3.0`
